...
OutputMap=function(
  ...
  MapRef, ## spatial pixels data frame with spatial extent, automatically passed if not specified.
  ...
  Plot1_Px=merge(MapRefPx[ ,c("Index_LR")], Plot1_Wide); ###summary(Plot1_Px)
  ...
  if(PlotLog){
    ...
    Plot2_Px=merge(MapRefPx[ ,c("Index_LR")], Plot2Log_Wide); ###summary(Plot2Log_Px)
