...
Version="function_DecisionSupportTool_V3.0.3.R"
source(paste0(HD, "/function_", Version))## Changed bc of way file was named
...
Output=DecisionTool(
  ...
  ################## Select core inputs #####################################--
  InputSpreadsheetName=".csv", ## csv input file with specified criteria
  ...
  CommentText="High Resolution Model and Low Resolution Maps",
  ...
  ArchiveInputSpreadsheet=TRUE ## v2.2.6 move input spreadsheet to output file?
)
Output
